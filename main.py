...
try:
    while True:
        ...
        temp_f = getattr(dht11.getTemperature(unit=1),
                         "__round__", lambda n: dht11.getTemperature(unit=1))
        ...
        print(
            f"A0: {a0:3d} | A1: {a1:3d} | {time_of_day} | Temp: {temp_str} | Humidity: {hum_str}")
